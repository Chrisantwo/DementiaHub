...
For a shorter three-actor rehearsal script, use `docs/TEAM_DRY_RUN_ACTOR_SCRIPT.md`.
...
|---|---|---|---|
| Jules | Caregiver | Fresh or controlled caregiver journey | Can log in, phone/profile ready, no unrelated history |
| Kim | Staff | Human follow-up and case ownership | Can access `/portal/staff` |
